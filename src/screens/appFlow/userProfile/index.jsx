...
const UserProfileScreen = ({ navigation, route }) => {
    ...
    const getUserFollowings = async () => {
        try {
            const response = await callApi("GET", `${api.checkFollowing}/${userName}`, {},
                (res) => {
        ...
        <ScrollView>
            <View style={styles.mainDiv}>
                ...
                <View style={styles.followersDiv}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate(routes.followers, { selected: 'followers', userName: userName, followers: userInfo.totalFollowers, followings: userInfo.totalFollowing, otherUserFollowers: true, otherUserFollowings: false })}>
                        <Text style={[styles.bold, styles.blackColor, styles.medium]}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate(routes.followers, { selected: 'following', userName: userName, followers: userInfo.totalFollowers, followings: userInfo.totalFollowing, otherUserFollowers: false, otherUserFollowings: true })}>
                        <Text style={[styles.bold, styles.blackColor, styles.medium]}>
                ...
                <View style={styles.buttonDiv}>
                    ...
                    <View style={{ width: widthPixel(160) }}>
                        <Button
                            ...
                            children="Message"
                            onPress={() => {
                                navigation.navigate(routes.individualMessages, { profileImage: user.profileImage, userName: user.userName, inbox: user.id }); // Navigate to the messages screen
                            }}
                            bidButton={true}
                            containerStyle={{ height: heightPixel(40) }}
                        />
